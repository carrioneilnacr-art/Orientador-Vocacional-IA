  ...
  return (
    <section className="w-full bg-gradient-to-br from-[#082A4A] to-[#0A3459] rounded-[24px] shadow-lg border border-[#00C2E0]/20 p-6 sm:p-10 mb-8 text-white relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 relative z-10">
        ...
        >
          <div className="w-10 h-10 rounded-xl bg-[#00C2E0]/20 flex items-center justify-center mb-4 border border-[#00C2E0]/30">
            <Users className="w-5 h-5 text-[#00C2E0]" />
          </div>
          <h3 className="text-lg font-bold text-white mb-2">Roles Típicos</h3>
          <ul className="space-y-2 text-sm text-[#A2C0D9]">
        ...
        <motion.div 
          ...
          className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm"
        >
          <div className="w-10 h-10 rounded-xl bg-[#18A86B]/20 flex items-center justify-center mb-4 border border-[#18A86B]/30">
            <Building className="w-5 h-5 text-[#18A86B]" />
          </div>
          <h3 className="text-lg font-bold text-white mb-2">Sectores Top</h3>
          <ul className="space-y-2 text-sm text-[#A2C0D9]">
        ...
        <motion.div 
          ...
          className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm md:col-span-2 lg:col-span-1"
        >
          <div className="w-10 h-10 rounded-xl bg-[#F4C95D]/20 flex items-center justify-center mb-4 border border-[#F4C95D]/30">
            <Coins className="w-5 h-5 text-[#F4C95D]" />
          </div>
          <h3 className="text-lg font-bold text-white mb-4">Ingreso Promedio Mensual</h3>
          
          <div className="space-y-4">
            <div>
              <div className="flex justify-between text-xs text-[#A2C0D9] mb-1">
                <span>Recién Egresado (Junior)</span>
                <span className="font-bold text-white">S/ 1,800 - S/ 2,500</span>
              </div>
            ...
            <div>
              <div className="flex justify-between text-xs text-[#A2C0D9] mb-1">
                <span>Con Experiencia (Semi-Senior/Senior)</span>
                <span className="font-bold text-white">S/ 3,500 - S/ 6,000+</span>
              </div>
              <div className="w-full bg-white/10 rounded-full h-1.5">
          ...
          <p className="text-[10px] text-[#A2C0D9]/70 mt-4 leading-tight">
            * Valores referenciales basados en el observatorio Ponte en Carrera y ofertas actuales en el mercado formal peruano. El ingreso varía según aptitudes, inglés y certificaciones.
          </p>
        </motion.div>
