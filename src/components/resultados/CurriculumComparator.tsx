      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 relative z-10">
        {universityData.map((uni, idx) => (
          <motion.div 
            ...
            className="flex flex-col bg-[#F8FCFF] border border-[#D6E5EF] hover:border-[#00C2E0]/40 rounded-2xl p-5 relative overflow-hidden group transition-all"
          >
            ...
            <div className="flex items-center justify-between mb-4 pl-3">
              ...
              <span className="text-[10px] font-medium px-2 py-1 bg-white rounded-md border border-[#D6E5EF] text-[#4F6B85]">
                {uni.campus}
              </span>
            </div>
